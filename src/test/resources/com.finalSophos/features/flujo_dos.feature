#Autor d.ramirez.0109@gmail.com
  ...
  Feature: Automatizacion de Widgets -> Date Picker
  ...
  Scenario: Automatizar funcionalidades de Widgets -> Date Picker
    When Seleccionar la fecha "20" y Seleccionar la hora "20:00" en el Date Picker
